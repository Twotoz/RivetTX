...
| OpenPocket Revision-A board services | safe-default `5V_VIDEO`, `5V_DISPLAY`, and `5V_ELRS` domains; charger/gauge/VBUS telemetry; backlight PWM; TW8836 reset, detection, bounded I2C ISP erase/program/readback/SHA-256/boot status; non-blocking I2C control snapshots; simulator RF lock and USB HID | native delayed-start, ISP-fault, checksum, and power-policy tests plus ESP32-S3 compile; assembled-board rail sequencing, TW8836 programming, charging, thermal, USB, and complete HIL execution remain pending first articles |
