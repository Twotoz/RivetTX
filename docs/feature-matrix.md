...
| OpenPocket Revision-A board services | safe-default `5V_VIDEO`, `5V_DISPLAY`, and `5V_ELRS` domains; charger/gauge/VBUS telemetry; backlight PWM; isolated AMT630A reset/flash ownership; non-blocking I2C control snapshots; simulator RF lock and USB HID | native delayed-start and power-policy tests; ESP32-S3 compile, assembled-board rail sequencing, AMT630A flash programming, charging, thermal, USB, and complete HIL validation remain open |
